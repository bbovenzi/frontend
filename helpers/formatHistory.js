...
const deriveXAxis = (data, axisLabel) => {
  switch (axisLabel) {
    ...
    case 'Last 30 Days':
      ...
      //   wait: currItem.mean_time_between / 60,
      //   oneMin: currItem.ontime['1_min'] / currItem.total_arrivals_analyzed * 100,
      //   twoMin: currItem.ontime['2_min'] / currItem.total_arrivals_analyzed * 100,
      //   threeMin: currItem.ontime['3_min'] / currItem.total_arrivals_analyzed * 100,
      //   fourMin: currItem.ontime['4_min'] / currItem.total_arrivals_analyzed * 100,
      //   fiveMin: currItem.ontime['5_min'] / currItem.total_arrivals_analyzed * 100,
      // }));
...
//   const wait = arr.reduce((acc, currItem) => acc + currItem.mean_time_between, 0) / arr.length / 60;
//   const oneMin = arr.reduce((acc, currItem) => acc + currItem.ontime['1_min'] / currItem.total_arrivals_analyzed, 0) / arr.length * 100;
//   const twoMin = arr.reduce((acc, currItem) => acc + currItem.ontime['2_min'] / currItem.total_arrivals_analyzed, 0) / arr.length * 100;
//   const threeMin = arr.reduce((acc, currItem) => acc + currItem.ontime['3_min'] / currItem.total_arrivals_analyzed, 0) / arr.length * 100;
//   const fourMin = arr.reduce((acc, currItem) => acc + currItem.ontime['4_min'] / currItem.total_arrivals_analyzed, 0) / arr.length * 100;
//   const fiveMin = arr.reduce((acc, currItem) => acc + currItem.ontime['5_min'] / currItem.total_arrivals_analyzed, 0) / arr.length * 100;
//   return {
//     wait,
//     oneMin,
...
const deriveYAxis = (data, axisLabel) => {
  switch (axisLabel) {
    ...
    // case '% Within 2 Minutes':
    // case '2_min':
    //   return data.map(item => item.twoMin);
    // case '% Within 3 Minutes':
    // case '3_min':
    //   return data.map(item => item.threeMin);
    // case '% Within 4 Minutes':
    // case '4_min':
    //   return data.map(item => item.fourMin);
